      ...
      {page === 'landing' && (
        <div className="geo-portal-landing">
          ...
          <div className="geo-portal-desc-text">
            establishing world connection...<br />
            loading pixel map interface...<br />
            memory allocation: sufficient<br />
            press <span className="geo-portal-desc-enter">[enter]</span> to proceed
          </div>
          <div className="geo-portal-globe-placeholder">
            <img src="/earthspin.gif" alt="Pixel Earth Globe" className="geo-portal-globe-img" />
          </div>
          <span
      ...
      {page === 'loading' && (
        <div className="geo-portal-loading-page">
          <div className="geo-portal-loading-bios-text">
            {loadingStep > 0 && <>initializing geo-portal subsystem...<br /></>}
            {loadingStep > 1 && <>scan complete.<br /></>}
            {loadingStep > 2 && <span className="geo-portal-loading-blink">loading</span>}
          </div>
        </div>
      )}
      {page === 'portal' && (
