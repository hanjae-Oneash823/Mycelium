...
import type { GeoPage, GeoTransition } from "@/types";

export default function GeoPortalView() {
  const [page, setPage] = useState<GeoPage>("landing"); // landing | loading | portal
  const [transition, setTransition] = useState<GeoTransition>(""); // '' | 'fade-out' | 'fade-in'
