                        ...
                        {bandNodes.map(cn => {
                          ...
                          return (
                            <div
                              ...
                              onMouseDown={e => startDrag(e, cn.node_id, col.canvas.id, day, node.title, node.node_type)}
                              onMouseEnter={() => { if (!dragState) setHoveredNode(cn.node_id); }}
                              onMouseLeave={() => setHoveredNode(null)}
                              style={{
                                width: NODE_W, height: NODE_H, flexShrink: 0,
                                padding: '8px 10px',
                                border: `1.5px solid ${isDraggingThis ? accentColor : 'rgba(255,255,255,0.45)'}`,
                                background: isDraggingThis ? 'rgba(255,255,255,0.04)' : '#1a1a1a',
                                cursor: node.node_type === 'task' ? 'grab' : 'default',
